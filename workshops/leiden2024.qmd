---
title: "PECE Workshop - University of Leiden"
...
- If you didn't already have an account **and you responded yes to the RSVP**, an account was created for you on [worldpece.org](worldpece.org). 
  - Please check your email for account username and password.  
  - Please try to log in, and be prepared to call me over if you can't. 

### Imagining an Archive

-   Identify a digital object that represents an imagined collaborative "project" to upload as an artifact. If you have a logo, you might upload it as an image artifact; if you have a project description, you might upload it as a text artifact; if you have a website, you might upload it as a Website artifact. 
-   One person in the group should share their screen with others as they talk through how to create this artifact. 
  ...
  -   Under **Contributors**, add all of the user names of the individuals in your group, *including yourself*.
  -   Under **Critical Commentary**, provide a brief description of the project.
  -   Under **Source**, provide a brief description of where this artifact came from. 
  ...
  -   Leave blank the following field: **Created Date** (*Note that this field is currently broken - because something always breaks right before a workshop.*)
...
### Collaborative Planning and Hermeneutics
...
### Report-outs and Demonstration of PECE Annotation Interfaces

### Overview of PECE Planning Tools
